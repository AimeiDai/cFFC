...
motifs = read.table("l3_motifs.consmiR.lowThreshold",stringsAsFactors=F)
...
write.table(all_tgs,"l3_consmiR.lowThreshold.allTargetType",row.names=F,col.names=T,sep="\t",quote=F)
...
save(type,file="l3_consmiR.lowThreshold.redundancy_type.RData")
...
write.table(mir_tg,"l3_consmiR.lowThreshold.redundancy",row.names=F,col.names=T,quote=F,sep="\t")
