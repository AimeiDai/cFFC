...
redundancy=read.table("../expression_noise/l3_consmiR.lowThreshold.allTargetType",sep="\t",header = T)
...
ggsave("L3_redundancyvsTau.pdf",width=1.5,height=3)
...
median(subset(aa,type=="low-redundant"|type=="high-redundant")$tau)
median(subset(aa,type=="low-redundant"|type=="high-redundant"|type=="non-redundant")$tau)
...
ggsave("L3_redundancyvsAges.pdf",width=3,height=3)
...
ggsave("L3_redundancyvsAgesTau.pdf",width=4.5,height=3)
...
pdf("L3_TukeyHSD.pdf",width=4,height=7)
...
# type           3   0.91 0.30390   7.188 8.39e-05 ***
#   Residuals   2486 105.11 0.04228                     
# ---
...
# 
# Df Sum Sq Mean Sq F value   Pr(>F)    
# type          3  1.104  0.3679   8.925 9.01e-06 ***
#   Residuals   507 20.899  0.0412                     
# ---
#   Signif. codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1
# Tukey multiple comparisons of means
# 95% family-wise confidence level
# 
# Df Sum Sq Mean Sq F value Pr(>F)    
# type           3   4.95  1.6501   47.89 <2e-16 ***
#   Residuals   1262  43.49  0.0345                   
# ---
#   Signif. codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1
# Tukey multiple comparisons of means
# 95% family-wise confidence level